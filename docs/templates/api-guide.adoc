...
Точка вызова для загрузки файла `/upload`

[[resources-upload-file-request]]
=== POST запрос загрузки файла
...
Точка вызова для проверки статуса видеофайла: `/check`
...
=== Ответ сервера при запросе на проверку
...
== Скачивание итогового видеофайла и превью
